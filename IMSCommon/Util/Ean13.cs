...
namespace IMSCommon.Util
{
    public class Ean13
    {
        ...
        public void DrawBarCodeFromImage(System.Drawing.Bitmap img)
        {

        }
        public void DrawEan13Barcode(System.Drawing.Graphics g, System.Drawing.Point pt,string companyName,string productName)
        {
            ...
            //Write opening text 
            g.DrawString(companyName, font, brush, new System.Drawing.PointF(5, 0));
            // Restore the GraphicsState.
            float finalPos = yStart + height + 5;
            // Draw Product ID.
            g.DrawString(productName, font, brush, new System.Drawing.PointF(0, finalPos));
            g.Restore(gs);
        }
